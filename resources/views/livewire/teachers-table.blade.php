<div>
    <form class="flex justify-center items-center gap-6" wire:submit.prevent="submit">
        <select wire:model.lazy="department" class="bg-gray-50 border border-gray-300 text-gray-900 sm:text-sm rounded-lg focus:ring-primary-600 focus:border-primary-600 block w-full p-2.5 dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-blue-500 dark:focus:border-blue-500">
        ...
        <table class="w-full text-sm text-left text-gray-500 dark:text-gray-400">
            ...
            <tbody>
                ...
                <tr class="bg-white border-b dark:bg-gray-800 dark:border-gray-700">
                    ...
                    <td class="py-4 px-6">
                        {{ $teacher->extraCurriculumActivities }}
                    </td>
                    <td class="py-4 px-6">
                        {{ $teacher->house }}
                    </td>
                    ...
                    <td>
                        <div class="flex items-center space-x-4 text-sm">
                            <button
                                wire:click='$emit("openModal", "edit-teacher", {{ json_encode(["teacher" => $teacher->slug]) }})'
