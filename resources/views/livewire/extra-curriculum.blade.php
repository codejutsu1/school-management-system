<div>
   ...
   <div class="overflow-x-auto relative mt-10">
        ...
        <div>
            {{ $allCurriculum->withQueryString()->links() }}
        </div>
    </div>
</div>
