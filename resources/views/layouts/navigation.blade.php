            ...
            <div class="flex">
                ...
                <div class="hidden space-x-8 sm:-my-px sm:ml-10 sm:flex">
                    ...
                    @can('departments')
                        ...
                        <x-nav-link>
                            <button id="resultDropdown" data-dropdown-toggle="resultDrop" class="text-gray-400 font-medium rounded-lg text-sm px-4 py-2.5 text-center inline-flex items-center " type="button">
                                Results
                                <svg class="ml-2 w-4 h-4" aria-hidden="true" fill="none" stroke="currentColor" viewBox="0 0 24 24" xmlns="http://www.w3.org/2000/svg">
                                    <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M19 9l-7 7-7-7"></path>
                                </svg>
                            ...
                            <!-- Dropdown menu -->
                            <div id="resultDrop" class="hidden z-10 w-44 bg-white rounded divide-y divide-gray-100 shadow dark:bg-gray-700">
                                <ul class="py-1 text-sm text-gray-700 dark:text-gray-200" aria-labelledby="resultDropdown">
                                    <li>
                                        <x-drop-link :href="route('result.individually')" :active="request()->routeIs('result.individually')">
                                            {{ __('Indiviually') }}
                                        </x-drop-link>
                                    </li>
                                    <li>
                                        <x-drop-link :href="route('result.by.subject')" :active="request()->routeIs('result.by.subject')">
                                            {{ __('By Subject') }}
                                        </x-drop-link>
                                    </li>
                                </ul>
